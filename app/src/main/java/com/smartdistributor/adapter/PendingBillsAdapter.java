...
public class PendingBillsAdapter extends RecyclerView.Adapter<PendingBillsAdapter.DataHolder> {
    ...
    public PendingBillsAdapter(List<CurrentBills> listdata, Context c) {
            ...
            lnr_current_supply_item.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    context.startActivity(new Intent(context, RetailerDetailActivity.class)
                            .putExtra("category", "Current Supply Bills"));
                }
            });
        }
